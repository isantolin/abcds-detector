...
def get_long_form_abcd_feature_configs() -> list[VideoFeature]:
  ...
  feature_configs = [
    VideoFeature(
      ...
      evaluation_criteria="""
                The first shot in the video changes in less than 3
                seconds.
            """,
      prompt_template="""
                Does the first shot in the video change in less than 3
                seconds?
            """,
      extra_instructions=[
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,  # Use full video for annotations
      evaluation_criteria="""
                Within ANY 5 consecutive seconds there are 5 or more
                shots in the video. These include hard cuts, soft
                transitions and camera changes such as camera pans,
                swipes, zooms, depth of field changes, tracking shots
                and movement of the camera.
            """,
      prompt_template="""
                Are there 5 or more shots within ANY 5 consecutive
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,  # Use full video for annotations
      evaluation_criteria="""
                There are at least 5 shot changes or visual cuts
                detected in the first 5 seconds of the video. These
                include hard cuts,
                soft transitions and camera changes such as camera pans,
                swipes, zooms, depth of field changes,
                tracking shots and movement of the camera.
            """,
      prompt_template="""
                Are there at least 5 shot changes or visual cuts
                detected in the first 5 seconds of the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
        (
    ...
    VideoFeature(
      ...
      evaluation_criteria="""
                Any supers (text overlays) have been incorporated at any
                time in the video.
            """,
      prompt_template="""
                Are there any supers (text overlays) at any time in the
                video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                The speech heard in the audio of the video matches OR is
                contextually supportive of the overlaid
                text shown on screen.
            """,
      prompt_template="""
                Does the speech match any supers (text overlays) in the
                video or is the speech contextually supportive
      ...
      extra_instructions=[
        ...
        """Provide the exact timestamp where supers are found and the timestamp
when
                the speech matches the supers or is contextually
                supportive of the overlaid text shown on the video.""",
      ],
      evaluation_method=EvaluationMethod.LLMS,
      evaluation_function="",
      include_in_evaluation=True,
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                The brand name is heard in the audio or speech at any
                time in the video.
            """,
      prompt_template="""
                Does the speech mention the brand {brand_name} at any
                time in the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      evaluation_criteria="""
                The brand name is heard in the audio or speech in the
                first 5 seconds of the video.
            """,
      prompt_template="""
                Does the speech mention the brand {brand_name} in the
                first 5 seconds of the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                Branding, defined as the brand name or brand logo are
                shown in-situation or overlaid at any time in the video.
            """,
      prompt_template="""
                Is the brand {brand_name} or brand logo {brand_name}
                visible at any time in the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
        (
    ...
    VideoFeature(
      ...
      evaluation_criteria="""
                Branding, defined as the brand name or brand logo are
                shown in-situation or overlaid in the first 5 seconds of
                the video.
            """,
      prompt_template="""
                Is the brand {brand_name} or brand logo {brand_name}
                visible in the first 5 seconds of the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
        (
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                The branded product names or generic product categories
                are heard or mentioned in the audio or speech
                at any time in the video.
            """,
      prompt_template="""
                Are any of the following products: {branded_products} or
                product categories: {branded_products_categories}
                heard at any time in the speech of the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
        """Provide the exact timestamp when the products {branded_products} or
product categories
                {branded_products_categories} are heard in the speech of
                the video.""",
        (
    ...
    VideoFeature(
      ...
      extra_instructions=[
        ...
        """Provide the exact timestamp when the products {branded_products}
                or product categories {branded_products_categories} are
                heard in the speech of the video.""",
        (
          "Return False if the products or product categories are not"
          " heard in the speech."
    ...
    VideoFeature(
      ...
      evaluation_criteria="""
                The branded product names or generic product categories
                are present in any text or overlay at any
                time in the video.
            """,
      prompt_template="""
               Is any of the following products: {branded_products} or
               product categories: {branded_products_categories}
...
product categories:
    ...
    VideoFeature(
      ...
      evaluation_criteria="""
                The branded product names or generic product categories
                are present in any text or overlay in the first 5
                seconds of the video.
            """,
      prompt_template="""
               Is any of the following products: {branded_products} or
               product categories: {branded_products_categories}
               present in any text or overlay in the first 5 seconds of
               the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                A product or branded packaging is visually present at
                any time in the video. Where the product is a service a
                relevant
                substitute should be shown such as via a branded app or
                branded service personnel.
            """,
      prompt_template="""
               Is any of the following products: {branded_products} or
               product categories: {branded_products_categories}
...
product categories:
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FIRST_5_SECS_VIDEO,
      evaluation_criteria="""
                A product or branded packaging is visually present in
                the first 5 seconds of the video. Where the product is a
                service,
                a relevant substitute should be shown such as via a
...
product categories:
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,  # Use full video for annotations
      evaluation_criteria="""
                The pace of the video is less than 2 seconds per
                shot/frame.
            """,
      prompt_template="""
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                People are shown in any capacity at any time in the
                video. Any human body parts are acceptable to pass
                this guideline. Alternate representations of people such
                as Animations or Cartoons ARE acceptable.
            """,
      prompt_template="""
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FIRST_5_SECS_VIDEO,
      evaluation_criteria="""
                People are shown in any capacity in the first 5 seconds
                of the video. Any human body parts are acceptable to
                pass this guideline.
                Alternate representations of people such as Animations
                or Cartoons ARE acceptable.
            """,
      prompt_template="""
               Are there people present in the first 5 seconds of the
               video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FIRST_5_SECS_VIDEO,
      evaluation_criteria="""
                At least one human face is present in the first 5
                seconds of the video. Alternate representations of
                people such as
                Animations or Cartoons ARE acceptable.
            """,
      prompt_template="""
               Is there a human face present in the first 5 seconds of
               the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                There is a close up of a human face at any time in the
                video.
            """,
      prompt_template="""
               Is there a close up of a human face present at any time
               the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FIRST_5_SECS_VIDEO,
      evaluation_criteria="""
                Speech is detected in the audio in the first 5 seconds
                of the video.
            """,
      prompt_template="""
               Is speech detected in the audio in the first 5 seconds of
               the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
                A 'Call To Action' phrase is heard or mentioned in the
                audio or speech at any time in the video.
            """,
      prompt_template="""
               Is any call to action heard or mentioned in the speech of
               the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
    ...
    VideoFeature(
      ...
      video_segment=VideoSegment.FULL_VIDEO,
      evaluation_criteria="""
               A 'Call To Action' phrase is detected in the video supers
               (overlaid text) at any time in the video.
            """,
      prompt_template="""
               Is any call to action detected in any text overlay at any
               time in the video?
            """,
      extra_instructions=[
        "Consider the following criteria for your answer: {criteria}",
