...
def find_elements_in_transcript(
  ...
  Args:
      ...
      elements_categories: list of element categories to find in the
          transcript
  ...
  for speech_transcription in speech_transcriptions:
    ...
    for alternative in speech_transcription.get("alternatives"):
      ...
      if (
        ...
        # Check if elements or elements categories are found in
        # transcript
        ...
        # For 1st 5 secs, check elements and elements_categories in
        # words since only the words[] contain times
