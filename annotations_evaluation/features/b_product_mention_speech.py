...
"""Module to detect Brand: Product Mention (Speech) & (First 5 seconds)
Annotations used:
...
def detect(
  ...
  """Detect Product Mention (Speech) & Product Mention (Speech) (1st 5s)
  Args:
      config: all the parameters
      feature_name: the name of the feature
      video_uri: video location in gcs
  ...
  # Video API: Evaluate product_mention_speech_feature and
  # product_mention_speech_1st_5_secs_feature
  if "speech_transcriptions" in speech_annotation_results:
    # Video API: Evaluate product_mention_speech &
